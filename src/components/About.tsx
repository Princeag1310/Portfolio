      ...
      >
        ...
        <div className="glass-panel" style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '30px', borderColor: 'rgba(0, 242, 254, 0.2)' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <p style={{ fontSize: '1.2rem', color: 'var(--text-secondary)', lineHeight: '1.8', fontWeight: 300 }}>
              I am a <span style={{ color: '#fff', fontWeight: 500 }}>B.Tech student</span> in Electrical and Electronics Engineering at <span style={{ color: '#fff', fontWeight: 500 }}>ABV-IIITM Gwalior</span> (CGPA: 9.42/10.0). I have a strong foundation in <span style={{ color: '#fff', fontWeight: 500 }}>competitive programming</span> and <span style={{ color: '#fff', fontWeight: 500 }}>full-stack web development</span>.
            </p>
            <p style={{ fontSize: '1.2rem', color: 'var(--text-secondary)', lineHeight: '1.8', fontWeight: 300 }}>
              Highly passionate about problem-solving, I am a <span style={{ color: '#fff', fontWeight: 500 }}>Guardian on LeetCode</span> (Rating: 2180) and a <span style={{ color: '#fff', fontWeight: 500 }}>4-star coder on CodeChef</span> (Rating: 1822). Beyond algorithms, I am an active <span style={{ color: '#fff', fontWeight: 500 }}>Open Source Contributor</span>, having merged multiple PRs across popular React and Next.js repositories during <span style={{ color: '#fff', fontWeight: 500 }}>Hacktoberfest 2025</span>.
            </p>
          </div>
